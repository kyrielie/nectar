...
public enum AO3KudosOutcome: Sendable, Equatable {
...
public enum AO3KudosRequest {
	...
	public static func makeRequest(workID: String, csrfToken: String, cookieHeaderValue: String?) -> URLRequest {
	...
	public static func outcome(statusCode: Int, data: Data?) -> AO3KudosOutcome {
		switch statusCode {
