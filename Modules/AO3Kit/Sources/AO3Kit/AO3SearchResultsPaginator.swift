...
@MainActor public enum AO3SearchResultsPaginator {
	...
	public static func loadNextPage(for feed: any AO3SearchFeedPageTracking, account: any AO3ArticleUpdating) async -> PageOutcome {
	...
	public static func refreshFirstPage(for feed: any AO3SearchFeedPageTracking, account: any AO3ArticleUpdating) async -> PageOutcome {
	...
	public static func validate(page: Int, against feed: any AO3SearchFeedPageTracking) -> PageValidationOutcome {
	...
	public static func fetchSpecificPage(_ page: Int, for feed: any AO3SearchFeedPageTracking, account: any AO3ArticleUpdating) async -> PageOutcome {
	...
	private static func fetchPage(_ page: Int, for feed: any AO3SearchFeedPageTracking, account: any AO3ArticleUpdating, advancePageTo: Int?) async -> PageOutcome {
		...
		do {
			...
			let isAlwaysAuthenticatedListing = AO3SearchResultsFetcher.isAlwaysAuthenticatedListingFeed(pageURL)
	...
	private static func url(for feed: any AO3SearchFeedPageTracking, page: Int) -> URL? {
