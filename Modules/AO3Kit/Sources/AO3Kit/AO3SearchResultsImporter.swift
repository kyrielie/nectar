...
@MainActor public enum AO3SearchResultsImporter {
	...
	public static func importFetchedPage(html: String, feedURL: String, feed: any AO3SearchFeedPageTracking, account: any AO3ArticleUpdating, advancePageTo: Int?, requestURL: URL? = nil) async -> ImportOutcome {
