...
private extension JSONFeedParser {
	...
	static func parseItem(_ itemDictionary: JSONDictionary, _ feedURL: String) -> ParsedItem? {
		...
		let ambrosia = parseAmbrosiaExtension(itemDictionary[Key.ambrosia] as? JSONDictionary)
		if dateModified == nil { dateModified = ambrosia.dateModified }

		return ParsedItem(syncServiceID: nil, uniqueID: uniqueID, feedURL: feedURL, url: url, externalURL: externalURL, title: title, language: language, contentHTML: contentHTML, contentText: contentText, markdown: nil, summary: summary, imageURL: imageURL, bannerImageURL: bannerImageURL, datePublished: datePublished, dateModified: dateModified, authors: authors, tags: tags, attachments: attachments, isAmbrosiaItem: ambrosia.isAmbrosiaItem, wordCount: ambrosia.wordCount, chapterCurrent: ambrosia.chapterCurrent, chapterTotal: ambrosia.chapterTotal, isComplete: ambrosia.isComplete, fandoms: ambrosia.fandoms, relationships: ambrosia.relationships, characters: ambrosia.characters, ratings: ambrosia.ratings, warnings: ambrosia.warnings, categories: ambrosia.categories, series: ambrosia.series, commentCount: ambrosia.commentCount, kudosCount: ambrosia.kudosCount, bookmarkCount: ambrosia.bookmarkCount, hitCount: ambrosia.hitCount, ao3WorkID: ambrosia.ao3WorkID, isAnthology: ambrosia.isAnthology, ao3SeriesID: ambrosia.ao3SeriesID, seriesName: ambrosia.bookSeriesName)
	}

	private struct AmbrosiaExtensionParsing {
		let wordCount: Int?; let chapterCurrent: Int?; let chapterTotal: Int?; let isComplete: Bool?
		let fandoms: [String]?; let relationships: [String]?; let characters: [String]?; let ratings: [String]?; let warnings: [String]?; let categories: [String]?
		let series: [ParsedSeriesEntry]?; let dateModified: Date?; let commentCount: Int?; let kudosCount: Int?; let bookmarkCount: Int?; let hitCount: Int?
		let ao3WorkID: String?; let isAnthology: Bool?; let ao3SeriesID: String?; let bookSeriesName: String?; let dateBookmarked: Date?; let isAmbrosiaItem: Bool; let bookKey: String?
	}

	private static func parseAmbrosiaExtension(_ ambrosia: JSONDictionary?) -> AmbrosiaExtensionParsing {
		guard let ambrosia else { return AmbrosiaExtensionParsing(wordCount: nil, chapterCurrent: nil, chapterTotal: nil, isComplete: nil, fandoms: nil, relationships: nil, characters: nil, ratings: nil, warnings: nil, categories: nil, series: nil, dateModified: nil, commentCount: nil, kudosCount: nil, bookmarkCount: nil, hitCount: nil, ao3WorkID: nil, isAnthology: nil, ao3SeriesID: nil, bookSeriesName: nil, dateBookmarked: nil, isAmbrosiaItem: false, bookKey: nil) }
		return AmbrosiaExtensionParsing(wordCount: ambrosia[Key.ambrosiaWordCount] as? Int, chapterCurrent: ambrosia[Key.ambrosiaChapterCurrent] as? Int, chapterTotal: ambrosia[Key.ambrosiaChapterTotal] as? Int, isComplete: ambrosia[Key.ambrosiaIsComplete] as? Bool, fandoms: ambrosia[Key.ambrosiaFandoms] as? [String], relationships: ambrosia[Key.ambrosiaRelationships] as? [String], characters: ambrosia[Key.ambrosiaCharacters] as? [String], ratings: ambrosia[Key.ambrosiaRatings] as? [String], warnings: ambrosia[Key.ambrosiaWarnings] as? [String], categories: ambrosia[Key.ambrosiaCategories] as? [String], series: parseAmbrosiaSeries(ambrosia), dateModified: parseDate(ambrosia[Key.ambrosiaDateModified] as? String), commentCount: ambrosia[Key.ambrosiaCommentCount] as? Int, kudosCount: ambrosia[Key.ambrosiaKudosCount] as? Int, bookmarkCount: ambrosia[Key.ambrosiaBookmarkCount] as? Int, hitCount: ambrosia[Key.ambrosiaHitCount] as? Int, ao3WorkID: ambrosia[Key.ambrosiaAO3WorkID] as? String, isAnthology: ambrosia[Key.ambrosiaIsAnthology] as? Bool, ao3SeriesID: ambrosia[Key.ambrosiaAO3SeriesID] as? String, bookSeriesName: ambrosia[Key.ambrosiaBookSeriesName] as? String, dateBookmarked: nil, isAmbrosiaItem: true, bookKey: nil)
	}
