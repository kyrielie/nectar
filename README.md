...
- [ ] Make AO3 look incredibly beautiful. It's an IOS app, it looks like an IOS app. If you want AO3 to look amazing use a site skin like the amazing [neos](https://github.com/ZerafinaCSS/neos) or [Rosé Pine](https://github.com/Wolfbatcat/ao3-rose-pine). There's lots of site skins out there, some that inspired themes for Nectar like those made by [intothisshadow](https://www.so-obsessed.com/ao3-site-skins/). Since Nectar does not replicate any AO3 website code, there's not really much to style. No cute icons or background wallpaper unfortunately. 
