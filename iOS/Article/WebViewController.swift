...
//		print("article.html written to \(fileURL.path)")
	...
	/// rejected, rather than that context only existing in a comment. See
	/// docs/article-color-pipeline.md.
	internal static func isDarkForColorResolution(selfTraitCollection: UITraitCollection, webViewTraitCollection: UITraitCollection) -> Bool {
