...
final class ArticleViewController: UIViewController {
	...
	override func viewDidAppear(_ animated: Bool) {
		...
		if let navigationController {
			...
			Self.logger.debug("ArticleViewController: viewDidAppear diagnostic navigationController=\(navigationController), interactivePopGestureRecognizer=\(String(describing: popGesture)), isEnabled=\(popGesture?.isEnabled ?? false), delegateIsPoppableDelegate=\(popGesture?.delegate === poppableDelegate)")
